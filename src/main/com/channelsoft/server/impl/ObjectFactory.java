 ...
 * generated in the com.channelsoft.server.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherByCityResponse_QNAME = new QName("http://impl.server.channelsoft.com/", "getWeatherByCityResponse");
    private final static QName _GetWeatherByCity_QNAME = new QName("http://impl.server.channelsoft.com/", "getWeatherByCity");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.channelsoft.server.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.server.channelsoft.com/", name = "getWeatherByCityResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.server.channelsoft.com/", name = "getWeatherByCity")
