...
public class QnSignSegmentUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String authorization = "/customWebservice/mvc/sessionDetail/querySegmentRecord.do?Nonce=10000233&Timestamp=1489655846&SecretId=AKIDz8krbsJ5yKBZQpn74WFkmLPx3gnPhESA";
        ...
        //isSegment
        //segmentNum
        String URI = "http://hbyd.ccod.com:8080/customWebservice/mvc/sessionDetail/querySegmentRecord.do?entId=" + entId + "&sessionId=3773041354418946050&pageNum=1&Signature="+Signature;
